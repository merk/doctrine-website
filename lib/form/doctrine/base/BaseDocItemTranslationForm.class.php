...
/**
 * DocItemTranslation form base class.
 *
 * @method DocItemTranslation getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDocItemTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('doc_item_translation[%s]');
